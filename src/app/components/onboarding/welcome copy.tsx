...
export default function OnbordingWelcome(props: any) {
    ...
    return (
        <div className="bg-[#FAFBFB] flex justify-between w-full h-screen">
        <div
            className="h-full w-[40%] bg-cover bg-no-repeat bg-center"
            style={{ backgroundImage: `url(${onboardng_welcome_bg.src})` }}
        ></div>

        <div className="h-full w-[50%] text-black flex items-center-safe  justify-center">
            <div className="w-full max-w-md flex flex-col gap-y-4">
                <p className="font-semibold text-[20px] InstrumentSans_Regular mb-4">
                    Basic Info
                </p>
                <div className="">
                ...
                <div className="w-full flex justify-center mt-[8rem]">
                    <button 
                    className="w-[80%] bg-[#082AD4] text-white rounded-lg py-1"
                    onClick={showVibe}
                    >
                        Next
                    </button>
